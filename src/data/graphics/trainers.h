...
const u32 gTrainerFrontPic_RocketTrio[] = INCBIN_U32("graphics/trainers/front_pics/rockettrio_front_pic.4bpp.lz");
const u32 gTrainerPalette_RocketTrio[] = INCBIN_U32("graphics/trainers/palettes/rockettrio.gbapal.lz");
